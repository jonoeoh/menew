...
To suppress the `after_save :send_email` callback, we can use the
...
user, allowing us to create the user without a notification and therefore avoid sending the welcome email.
